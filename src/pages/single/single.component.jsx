...
class  SinglePage extends Component {
    ...
    return(
        <div className='single-page' >
            ...
            <img className='header-image' src={require(`../../assets/images/portofolio/${filteredItems[0].image}.jpg`)} alt={filteredItems[0].image}></img>
            ...
            {(this.state.isOpen && this.state.imgName) ?
                        ...
                        <Modal open={this.state.isOpen} onClose={this.onCloseModal} styles={bg} >
                            ...
                            <img style={styles} className='modal-image' src={require(`../../assets/images/portofolio/${this.state.imgName}.jpg`)} alt=""/>
                        </Modal>
                        :
                        ''
